          ...
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item me-3">
             <NavLink className="nav-link position-relative" aria-current="page" to="/wishlist">
                ...
                {counterWish? <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                  {counterWish}
                  <span className="visually-hidden">unread messages</span>
                </span>:''}
              </NavLink>
            ...
            <li className="nav-item">
             <NavLink onClick={clearLogin} className="nav-link position-relative" aria-current="page" to="/signIn">
                Sign Out
              </NavLink>
            </li>

...
export default function SignUp() {
  ...
  function validationSchema() {
    let schema = new Yup.object({
      ...
      phone: Yup.string()
        .matches(/^01[0-2]\d{1,8}$/, "accept only egypt phone numbers")
        .required(),
      password: Yup.string()
        .matches(
          /^[A-Z][a-zA-Z0-9@#!%$&^*()]{6,}$/,
          "Password must match, Start Capital and more than 6 character"
        )
        .required(),
            ...
            <div className="ms-4">
              ...
              <form onSubmit={register.handleSubmit}>
                <div className="row">
                  ...
                  <div className="col-md-12">
                    {errorMessage ? (
                      <div className="d-flex align-items-center mb-2 alert alert-danger alert-input">
                        {errorMessage}
                      </div>
                    ) : (
                      ""

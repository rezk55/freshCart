...
export default function Footer() {
  return (
    <>
      <footer className='footer bg-main-light py-5 mt-5 overflow-hidden' id='footer'>
        <div className="container">
          ...
          <form className='d-flex justify-content-between gap-4'>
            <input className='form-control w-75  ms-4' type="email" name="email" placeholder="Email"/>
            ...
            <div className="col-lg-5 ps-1">
              ...
              <div className="partners">
                <ul className='list-unstyled m-0 d-flex gap-2'>
                  <li>
                    <Link to="http://"><img src={partner1} /></Link>
                  </li>
                  <li>
                    <Link to="http://"><img src={partner2} /></Link>
                  </li>
                  <li>
                    <Link to="http://"><img src={partner3} /></Link>
                  </li>
                  <li>
                    <Link to="http://"><img src={partner4} /></Link>
                  </li>
                  <li>
                    <Link to="http://"><img src={partner5} /></Link>
                  </li>
                </ul>
              </div>
              </div>         
              ...
              <div className="download-app">
                <div className="row align-items-center border">
                  <div className="col-md-7 p-0">
                    <h6 className='fw-bold ms-3 mt-3 m-lg-0  text-lg-end ' >Get deliveries with FreshCart</h6>
                  </div>
                  <div className="col-md-5 ">
                    <ul className="links list-unstyled d-flex gap-2 m-0">
                      <li className=''>
                        <Link className='' to="http://"><img className='w-100' src={appstore}/></Link>
                      </li>
                      <li className=''>
                        <Link className='' to="http://"><img className='w-100' src={googleplay}/></Link>
                      </li>
                    </ul>
                  </div>
                </div>
